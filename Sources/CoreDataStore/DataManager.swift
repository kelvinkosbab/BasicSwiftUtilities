...
public extension DataManager {
    ...
    func createOrUpdate(_ object: ObjectType.ManagedObject.StructType) {
        let cdObject = self.cdFetchOne(id: object.identifier) ?? self.create()
    ...
    func delete(_ object: ObjectType.ManagedObject.StructType) {
...
extension DataManager where ObjectType.ManagedObject : CoreDataParentIdentifiable {
    ...
    func createObserver<Delegate: DataObserverDelegate>(id: String, parentId: String) -> DataObserver<Delegate> where Delegate.ObjectType.ManagedObject: CoreDataParentIdentifiable {
        return DataObserver(id: id, parentId: parentId, context: self.context)
    }
    
    func createObserver<Delegate: DataObserverDelegate>(parentId: String) -> DataObserver<Delegate> where Delegate.ObjectType.ManagedObject: CoreDataParentIdentifiable {
